...
namespace Maltus_Arkanoïd
{
    public partial class Jeu : Form
    {
        ...
        public Jeu(string nomJoueur, int niveau, string nomNiveau,bool natif, bool NJIN)
        {
            InitializeComponent();
        ...
        ****************************************/
        ...
        private void Form3_KeyDown(object sender, KeyEventArgs e)
        {
            switch(e.KeyCode)
            {
                ...
                case Keys.A:
                    if (NJ)
                    {
                        vaisseauObjet2.SensGauche = true;
                        if (!timer4.Enabled)
                        {
                            timer4.Start();
                        }
                ...
                case Keys.Z:
                    if (NJ)
                    {
                        vaisseauObjet2.SensGauche = false;
                        if (!timer4.Enabled) { timer4.Start(); }
                    }
                    break;
            }
        }
        ...
        private void Jeu_KeyUp(object sender, KeyEventArgs e)
        {
            ...
            else if ((e.KeyCode == Keys.A || e.KeyCode == Keys.Z) && NJ)
            { 
                timer4.Stop();
            }
        }
